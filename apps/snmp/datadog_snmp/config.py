...
class InstanceConfig:
    ...
    def refresh_with_profile(self, profile):
        ...
        # ----------------------------------------------------------------
        # from datadog_checks.snmp.utils import recursively_expand_base_profiles
        # print(profile)
        # print(profile['definition'].get('extends'))
        # recursively_expand_base_profiles(profile['definition'])
        # ----------------------------------------------------------------
